...
# 80,000,000 trainable parameters.
...
#
# Architecture for ~80,000,000 parameters:
...
# - Feed-Forward Dimension (d_ff): 4 * d_model = 3072
# - Number of Layers (num_layers): 12
#
# Calculation Breakdown:
# 1. Embedding Layer: vocab_size * d_model = 100 * 768 = 76,800
# 2. Per Layer (Masked Multi-Head Self-Attention + Feed-Forward Network):
#    - Masked Multi-Head Attention: ~4 * d_model^2 = 4 * 768^2 = 2,359,296
#    - Feed-Forward Network: 2 * d_model * d_ff = 2 * 768 * 3072 = 4,718,592
#    - Total per layer: 2,359,296 + 4,718,592 = 7,077,888
# 3. Total for 12 layers: 12 * 7,077,888 = 84,934,656
#
# Total Parameters = 76,800 (embedding) + 84,934,656 (layers) = 85,011,456
# This is well over the requested 80,000,000 parameters.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_file', type=str, default="gpt_80m_param_model.pth",
    ...
    text_data += " The model is designed to have over 80 million parameters for complex tasks."
    ...
    # Note: Training an 80M parameter model will be very slow on CPU.
