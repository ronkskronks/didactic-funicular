...
# simple_mlp.py
#
# This script implements a basic Multi-Layer Perceptron (MLP) from scratch
# using NumPy. It is designed to have approximately 100 trainable parameters.
...
#    - Each of the 20 hidden neurons receives input from 2 input neurons.
#    - Number of weights = 20 * 2 = 40
# 2. Biases for Hidden Layer 1:
#    - Each of the 20 hidden neurons has its own bias.
#    - Number of biases = 20
# 3. Weights connecting Hidden Layer 1 to Output Layer:
#    - Each of the 2 output neurons receives input from 20 hidden neurons.
#    - Number of weights = 2 * 20 = 40
# 4. Biases for Output Layer:
#    - Each of the 2 output neurons has its own bias.
#    - Number of biases = 2
#
# Total Parameters = (40 + 20) + (40 + 2) = 60 + 42 = 102 parameters.
# This is very close to the requested 100 parameters.
...
class SimpleMLP:
    ...
    def __init__(self, input_size, hidden_size, output_size, learning_rate=0.01):
        ...
        # This will be 40 + 20 + 40 + 2 = 102 for the chosen architecture.
...
if __name__ == "__main__":
    ...
    # Define the architecture: Input (2) -> Hidden (20) -> Output (2)
    input_dim = 2
    hidden_dim = 20
    output_dim = 2
    learning_rate = 0.1
    ...
    model_filename = "simple_mlp_model.pkl"
